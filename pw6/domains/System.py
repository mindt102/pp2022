...
class System:
    ...
    def load_students(self):
        students = Utils.load_pickle(self.get_students_file())
        if not students:
            return {}
    ...
    def load_courses(self):
        courses = Utils.load_pickle(self.get_courses_file())
        if not courses:
            return {}
    ...
    def set_students(self):
        ...
        Utils.save_pickle(self.get_students_file(), self.get_students())
        self.list_students()
    ...
    def set_courses(self):
        ...
        Utils.save_pickle(self.get_courses_file(), self.get_courses())
        self.list_courses()
